...
def project_details(id):
    ...
    # Base query
    query = Task.query.filter(Task.project_id == id)
    ...
    filtered_tasks = query.options(joinedload(Task.assignees)).all()

    # Split for Kanban columns
